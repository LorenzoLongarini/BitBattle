...
import { checkGamePlayer, checkGridSize, checkMove } from "./middleware/game_middleware";
...
app.post("/game/create", jsonParser, checkJwt, checkGridSize, (req: Request, res: Response) => {
    createGame(req, res);
});
